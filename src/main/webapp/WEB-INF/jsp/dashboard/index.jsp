...
<body class="no-skin">
	...
	<div class="alert alert-block alert-success">
		...
		<i class="ace-icon fa fa-check green"></i> Welcome to <strong
			class="green"> Ace <small>(v1.3)</small>
						...
						<div class="tab-content padding-8">
							<div id="task-tab" class="tab-pane active">
								...
								<ul id="tasks" class="item-list">
									...
									<li class="item-red clearfix"><label class="inline">
											<input type="checkbox" class="ace" /> <span class="lbl">
												Fixing bugs</span>
									</label> <!-- #section:custom/extra.action-buttons -->
										<div class="pull-right action-buttons">
											<a href="#" class="blue"> <i
												...
												class="ace-icon fa fa-flag bigger-130"></i>
											</a>
										</div> <!-- /section:custom/extra.action-buttons --></li>

									<li class="item-default clearfix"><label class="inline">
											<input type="checkbox" class="ace" /> <span class="lbl">
												Adding new features</span>
									</label> <!-- #section:elements.dropdown.hover -->
										<div
										...
										</div> <!-- /section:elements.dropdown.hover --></li>
							...
							<div id="member-tab" class="tab-pane">
								...
								<div class="clearfix">
									<div class="itemdiv memberdiv">
										...
										<div class="body">
											...
											<div class="time">
												<i class="ace-icon fa fa-clock-o"></i> <span class="green">20
													min</span>
											</div>
									...
									<div class="itemdiv memberdiv">
										...
										<div class="body">
											...
											<div class="time">
												<i class="ace-icon fa fa-clock-o"></i> <span class="green">1
													hour</span>
											</div>
									...
									<div class="itemdiv memberdiv">
										...
										<div class="body">
											...
											<div class="time">
												<i class="ace-icon fa fa-clock-o"></i> <span class="green">2
													hour</span>
											</div>
									...
									<div class="itemdiv memberdiv">
										...
										<div class="body">
											...
											<div class="time">
												<i class="ace-icon fa fa-clock-o"></i> <span class="green">3
													hour</span>
											</div>
									...
									<div class="itemdiv memberdiv">
										...
										<div class="body">
											...
											<div class="time">
												<i class="ace-icon fa fa-clock-o"></i> <span class="green">yesterday</span>
											</div>
								...
								<div class="center">
									...
									<a href="#" class="btn btn-sm btn-white btn-info"> See all
										members &nbsp; <i class="ace-icon fa fa-arrow-right"></i>
									</a>
								</div>
							...
							<div id="comment-tab" class="tab-pane">
								...
								<div class="comments">
									<div class="itemdiv commentdiv">
										...
										<div class="body">
											...
											<div class="text">
												<i class="ace-icon fa fa-quote-left"></i> Lorem ipsum dolor
												sit amet, consectetur adipiscing elit. Quisque commodo massa
								...
								<div class="center">
									...
									&nbsp; <a href="#" class="btn btn-sm btn-white btn-info">
										See all comments &nbsp; <i class="ace-icon fa fa-arrow-right"></i>
									</a>
								</div>
					...
					<div class="widget-main no-padding">
						...
						<div class="dialogs">
							...
							<div class="itemdiv dialogdiv">
								...
								<div class="body">
									<div class="time">
										<i class="ace-icon fa fa-clock-o"></i> <span class="orange">2
											min</span>
									</div>
